    ...
    <View contentContainerStyle={styles.container}>
      ...
      {selectedCampaign && (
        <View>
          ...
          {goods.map((good, index) => (
            <View key={index} style={styles.goodContainer}>
              ...
              <TextInput
                ...
                onChangeText={(value) => handleInputChange(index, "quantity", parseInt(value) || 0)}
              />
            </View>
          ))}
          ...
          <Button title="Submit Donation" color="#4CAF50" onPress={handleSubmit} />
        </View>
      )}
      <Button title="Edit Campaign" color="#4CAF50" onPress={() => navigation.navigate("EditCampaignGoods")} />
      <Button title="Create Campaign" color="#4CAF50" onPress={() => navigation.navigate("createCampaign")} />
    </View>
  ); 
};
